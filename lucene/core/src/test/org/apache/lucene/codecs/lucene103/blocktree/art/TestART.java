...
//    assertEquals(new Output(0, false, new BytesRef("abc1")), artReader.find(new
// BytesRef("abc1")));
//    assertEquals(
...
//    assertEquals(new Output(0, false, new BytesRef("abc2")), artReader.find(new
// BytesRef("abc2")));
//    assertEquals(
//        new Output(0, false, new BytesRef("abc234")), artReader.find(new BytesRef("abc234")));
//    assertEquals(new Output(0, false, new BytesRef("abc3")), artReader.find(new
// BytesRef("abc3")));
...
//    artBuilder.insert(new BytesRef(("abc")), new Output(0, false, new BytesRef(("abc"))));
//    for (int i = 0; i < 10; i++) {
//      artBuilder.insert(new BytesRef(("abc" + i)), new Output(0, false, new BytesRef(("abc" +
// i))));
//    }
...
//    for (byte i = 65; i < 91; i++) {
//      byte[] bytes = {97, 98, 99, i};
//      assertEquals(new Output(0, false, new BytesRef(bytes)), artReader.find(new
// BytesRef(bytes)));
//    }
//
//    // Load.
